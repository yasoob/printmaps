import { CZECHIA_ADMIN_1_REGIONS } from '../data/czechiaAdmin1';
...
export const CZECHIA_COUNTRY_AREA = {
  countryCode: 'CZE' as const,
  id: 'CZE' as const,
  name: 'Czechia',
  ...
  geometry: { type: 'Polygon' as const, coordinates: [[
    ...
    [17.545007, 48.800019], [17.101985, 48.816969], [16.960288, 48.596982], [16.499283, 48.785808],
    [16.029647, 48.733899], [15.253416, 49.039074], [14.901447, 48.964402], [14.338898, 48.555305],
    [13.595946, 48.877172], [13.031329, 49.307068], [12.521024, 49.547415], [12.415191, 49.969121],
    [12.240111, 50.266338], [12.966837, 50.484076], [13.338132, 50.733234], [14.056228, 50.926918],
    [14.307013, 51.117268], [14.570718, 51.002339], [15.016996, 51.106674],
  ]] as [number, number][][] },
};

export const CZECHIA_REGION_AREAS = CZECHIA_ADMIN_1_REGIONS.map((region) => ({
  countryCode: 'CZE' as const,
  id: region.id,
  name: region.name,
