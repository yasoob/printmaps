...
1. Broader styles, language, and detail controls.
2. Administrative area selection, merge, fill, outline, and invert.
3. Secondary tools such as elevation profiles.
