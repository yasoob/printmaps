...
1. Administrative area selection, merge, fill, outline, and invert.
2. Secondary tools such as elevation profiles.
...
- PNG physical-resolution metadata, layered PSD, CMYK/PDF-X, account sharing, provider-backed snapped routes, and custom-image PDF embedding are not implemented.
