...
Build one bounded portable project ZIP slice with deterministic download/upload round trips and explicit size/asset guards. Geometry editing/styles and the Mapbox renderer/storage decision remain later blockers.
