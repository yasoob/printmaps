...
Replace browser-preview resampling with native target-resolution basemap tile/strip capture while preserving preflight guards, cancellation, attribution and exact PNG dimensions. A final complete nominal cross-browser workflow remains required afterward.
