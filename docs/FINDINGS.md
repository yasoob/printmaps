...
Build bounded polygon-vertex editing while preserving ring closure, distinct-vertex validation, live feedback, history and print/export fidelity. Native high-resolution map detail and the Mapbox renderer/storage decision remain later blockers.
