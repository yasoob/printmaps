...
Wire the existing deterministic print scene into one bounded layered-SVG export surface with named-group structural and interaction coverage. Keep the raster-basemap/vector-overlay limitation explicit; PDF remains after that slice.
