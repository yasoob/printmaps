...
Advance the highest-value compliance-safe route parity: travel profiles, straight/arc expert segments and printable mode icons, while keeping address search and road snapping fail-closed until the accepted Mapbox display/storage requirements are satisfied.
