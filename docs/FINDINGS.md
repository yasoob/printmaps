...
Advance the next compliance-safe parity workflow: richer POI labels, marker shapes/icons and bounded spreadsheet entry, while leaving address search/geocoding fail-closed unless the accepted provider-storage boundary permits durable results.
