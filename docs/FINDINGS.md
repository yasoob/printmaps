...
Build one bounded user-visible content-editing slice, prioritizing canonical route/POI/shape presentation controls with live map, undo/redo and print/export fidelity. Geometry vertex editing and the Mapbox renderer/storage decision remain later blockers.
