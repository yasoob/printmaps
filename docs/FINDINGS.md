...
Build one bounded canonical map-visibility slice: persist major feature/label category state, apply it through the renderer boundary across style switches, and cover Undo/Redo, Save/Open/autosave and real-browser recovery. Portable ZIP, geometry editing and the Mapbox renderer/storage decision remain later blockers.
