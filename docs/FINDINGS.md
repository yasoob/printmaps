...
Build one bounded geometry-editing slice, prioritizing direct POI coordinate editing or route/shape vertex editing with live map feedback, undo/redo and print/export fidelity. Native high-resolution map detail and the Mapbox renderer/storage decision remain later blockers.
