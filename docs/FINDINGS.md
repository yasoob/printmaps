...
Add validated custom PNG/JPEG/SVG marker assets with strict type/dimension/byte limits, canonical hash-owned project storage and live/vector-print fidelity. Broader styles, language and detail controls follow the custom-marker sub-slice.
