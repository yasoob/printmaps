...
Build the public Mapbox token/origin setup and actionable failure guidance behind the provider boundary, while recording the compliance-first renderer/storage decision. Native high-resolution map detail remains a later blocker.
