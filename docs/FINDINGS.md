...
Build one bounded polygon authoring slice: capture a valid closed shape from map clicks with draft feedback, explicit Finish/Cancel, selection, Undo/Redo, document-epoch invalidation and print/export coverage. Portable ZIP, route editing/styles, map design controls and the Mapbox renderer/storage decision remain later completion blockers.
