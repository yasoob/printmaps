...
Build one bounded canonical global text-scale slice: persist a validated scale, apply it through the renderer boundary, and cover Undo/Redo, Save/Open/autosave, style switching and browser behavior. Portable ZIP, geometry editing, feature visibility and the Mapbox renderer/storage decision remain later blockers.
